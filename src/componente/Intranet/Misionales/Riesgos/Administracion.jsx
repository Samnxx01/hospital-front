...
export default function Administracion() {
    ...
    useEffect(() => {
        const fetchCalidad = async () => {
            try {
                const response = await fetch('http://localhost:8080/api/documentos/riesgos/listararchivos', {
                    method: 'GET',
                    headers: {
                ...
                if (data && data.listarRiesgos) {
                    setlistarPDF(data.listarRiesgos);
                    setListarDocumentos(data.listarRiesgos);
                } else {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://localhost:8080/api/documentos/riesgos/guardararchivos', {
                method: 'POST',
                body: formDataToSend,
            });
