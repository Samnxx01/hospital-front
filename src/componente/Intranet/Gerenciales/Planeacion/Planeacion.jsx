...
export default function Planeacion() {
  ...
  useEffect(() => {
    const fetchCalidad = async () => {
      try {
        const response = await fetch('http://localhost:8080/api/documentos/planeacion/listararchivos', {
          method: 'GET',
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch('http://localhost:8080/api/documentos/planeacion/guardararchivos', {
        method: 'POST',
        body: formDataToSend,
      });
